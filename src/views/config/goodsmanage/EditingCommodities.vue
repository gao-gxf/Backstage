    ...
    created:function(){
            ...
            methods: {
                  ...
                  GetGoodsDetail(){
                        ...
                        resName.GoodsDetail(params).then(res => {
                                                //数据处理
                                                if (res.code === 1) {
                                                      _this.form = res.data;
                                                      ...
                                                      if(_this.form.wendor_id == 1){
                                                            _this.form.wendor_id = "涂鸦智能"
                                                      }
                                                      ...
                                                      //回显商品类型
                                                      let obj = {}; 
                                                      obj = this.goodsType.find((item)=>{//这里的userRoleList就是上面遍历的数据源 
                                                            return item.id === res.data.goods_type1;//筛选出匹配数据 
                                                      }); 
                                                      _this.form.value1 = obj; 
                                                      this.GetGoodsType2(obj.id,res.data.goods_type2,res.data.goods_type3);
                  ...
                  submitEdit:function(){
                        ...
                        _this.$refs.form.validate(valid => {
                              if (valid) {
                                    ...
                                    if(_this.form.wendor_id == "涂鸦智能"){
                                          _this.form.wendor_id = 1
                                    }
