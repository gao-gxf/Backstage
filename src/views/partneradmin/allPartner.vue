  ...
  <section>
    <el-row :model="filter" type="flex" class="row-bg" justify="space-between">
      ...
      <div style="float:right;width:300px;">
        <el-input v-model="filter.ID" placeholder="Duotel ID" style="width:70%" size="mini"></el-input>
        <el-button
          type="primary"
    ...
    >
      ...
      <el-table-column align="center" sortable label="代理商名称" width="150" prop="company_name">
      ...
      <el-table-column label="操作" align="center" width="250">
        <template slot-scope="scope">
          <div v-if="scope.row.partner_status == '0'">
            <el-button
              type="success"
          ...
          <div v-else-if="scope.row.partner_status == '1'">
