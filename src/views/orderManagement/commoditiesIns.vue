			...
			<el-tab-pane label="商品信息">
				<el-form ref="form" :model="form" :rules="addFormRules" :hide-required-asterisk="true" label-width="80px">
					<el-form-item label="商品名称" prop="goods_name">
						...
						<el-input v-model="form.goods_model" placeholder="请输入产品型号"></el-input>
					</el-form-item>
					<el-form-item label="CPK编码">
						<el-input v-model="form.goods_cpk" placeholder="请输入CPK编码"></el-input>
					</el-form-item>
                              <el-form-item label="物料编码" prop="material_code">
						<el-input v-model="form.material_code" placeholder="请输入物料编码"></el-input>
					</el-form-item>
						...
						<el-input v-model="form.goods_weight" placeholder="请输入商品重量"></el-input>
						 ...
						 <el-radio-group v-model="form.is_fragile" size="small">
						 ...
						 <el-radio-group v-model="form.battery" size="small">
                                          <el-radio-button label="无" value="1">无</el-radio-button>
                                          <el-radio-button label="有" value="2">有</el-radio-button>
                                    </el-radio-group>
					</el-form-item>
                             
                              <el-form-item  label="供应商" prop="supplier_id">
                                    <el-select v-model="form.supplier_id"  placeholder="请选供应商" style="display:block;">
                                          <el-option v-for="item in supplier" :key="item.id" :label="item.supplier_name" :value="item.id"></el-option>
                                    </el-select>
                              </el-form-item>
                              <el-form-item label="商品类型" required>
                                    <el-col style="width:30%;margin-right:5%;">
                                          <el-form-item prop="value1" style="width:100%;">
                                                <el-select style="display:block;" v-model="form.value1" @change="selGoods" value-key="id" placeholder="请选商品类型">
                                    ...
                                    <el-col v-if="gtype2"  style="width:30%;margin-right:5%;">
                                          <el-form-item prop="value2" style="width:100%;">
                                                <el-select style="display:block;" v-if="gtype2" v-model="form.value2" @change="selGoods2" value-key="id" placeholder="请选商品类型">
                                    ...
                                    <el-col v-if="gtype3"  style="width:30%;">
                                          <el-form-item prop="goods_type3" style="width:100%;">
                                                <el-select style="display:block;" v-if="gtype3" v-model="form.goods_type3" @change="selGoods3" value-key="id" placeholder="请选商品类型">
					...
					<el-form-item label="促销价格" prop="shop_price">
						<el-input v-model="form.shop_price" placeholder="请输入促销价格"></el-input>
					</el-form-item>
                              <el-form-item label="进货价格" prop="internal_price">
						<el-input v-model="form.internal_price" placeholder="请输入进货价格"></el-input>
					</el-form-item>
					<el-form-item label="网销价格" prop="distribution_price">
						<el-input v-model="form.distribution_price" placeholder="请输入分销价格"></el-input>
					</el-form-item>
					...
					<el-form-item label="商品属性" prop="goods_attr" style="width:100%;">
						<el-input type="textarea" v-model="form.goods_attr" placeholder="请输入商品属性"></el-input>
					</el-form-item>
                  ...
                  submitEdit:function(){
                        ...
                        _this.$refs.form.validate(valid => {
                              if (valid) {
                                    ...
                                    if(_this.form.is_fragile == "否" ){
                                          _this.form.is_fragile = 1
                                    }else if(_this.form.is_fragile == "是"){
                                          _this.form.is_fragile = 2
                                    }
                                    if(_this.form.battery == "无" ){
                                          _this.form.battery = 1
                                    }else if(_this.form.battery == "有"){
                                          _this.form.battery = 2
                                    }
