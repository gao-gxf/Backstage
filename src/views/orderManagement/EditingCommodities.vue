    ...
    <el-tabs type="border-card">
      <el-tab-pane label="商品信息">
        ...
        >
          ...
          <el-form-item label="是否易碎" prop="is_fragile">
          ...
          <el-form-item label="有无电池" prop="battery">
                ...
                <thead id="amsThead">
                  <tr v-if="tableHeader!=''">
                    ...
                    <th class="common-input">
                      ...
                      <el-input v-model="market_value"></el-input>
                    </th>
                    <th class="common-input">
                      <p>
                        <span class="red">*</span>促销价
                      </p>
                      <el-input v-model="shop_price"></el-input>
                    </th>
                  </tr>
                </thead>
                <tbody id="amsTbody">
                  <tr v-for="(row,index) in tableData" :key="index">
                    <td class="normsC">
                      <input name="recommend" :value="index" type="radio" v-model="checkRadio" />
                    </td>
                    ...
                    <td>
                      <input v-model="row.market_value" class="el-input__inner" />
                    </td>
                    <td>
                      <input v-model="row.shop_price" class="el-input__inner" />
                    </td>
                  </tr>
                </tbody>
              </table>
    ...
    submitEdit: function() {
      ...
      _this.$refs.form.validate(valid => {
        if (valid) {
          ...
          console.log(_this.form.battery);
