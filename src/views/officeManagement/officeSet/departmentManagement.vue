  ...
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true">
        <el-form-item class="left">
          <el-button type="primary" size="mini" icon="el-icon-plus" @click="handleAdd">部门</el-button>
        </el-form-item>
      </el-form>
    </el-col>
    ...
    >
      <el-form
        ...
        label-width="80px"
      >
        <el-form-item label="部门名称" prop="class_value">
          <el-input placeholder="请输入部门名称" v-model="editForm.class_value" class="input-with-select"></el-input>
        </el-form-item>
      </el-form>
    ...
    >
      ...
      >
        <el-form-item label="部门名称" prop="class_value">
          <el-input placeholder="请输入部门名称" v-model="addForm.class_value" class="input-with-select"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
