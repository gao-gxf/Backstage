<template>
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true">
        <el-form-item class="left">
          <el-button type="primary" size="mini" icon="el-icon-plus" @click="handleAdd">项目业主</el-button>
        </el-form-item>
      </el-form>
    </el-col>
    ...
    <el-table
      ...
      style="width: 99.9%;"
      border>
      <el-table-column prop="class_value" label="业主名称" align="center"></el-table-column>
    ...
    >
      <el-form
        ...
        label-width="80px"
      >
        <el-form-item label="业主名称" prop="class_value">
          <el-input placeholder="请输入业主名称" v-model="editForm.class_value" class="input-with-select"></el-input>
        </el-form-item>
      </el-form>
    ...
    >
      ...
      >
        <el-form-item label="业主名称" prop="class_value">
          <el-input placeholder="请输入业主名称" v-model="addForm.class_value" class="input-with-select"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
