  ...
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters">
          ...
          <el-button type="primary" icon="el-icon-search" size="mini" v-on:click="roleGroupList">查询</el-button>
        </el-form-item>
            <el-form-item class="right">
        ...
        <el-form-item class="left">
          <el-button type="primary" icon="el-icon-plus" size="mini" @click="handleAdd">添加权限组</el-button>
        </el-form-item>
      </el-form>
    </el-col>
    ...
    <el-table
      ...
      style="width: 100%;"
    >
      <el-table-column prop="id" label="角色组ID" min-width="200"></el-table-column>
      <el-table-column prop="name" label="角色组名称" min-width="200"></el-table-column>
      <el-table-column prop="permission_num" label="权限数" min-width="180" sortable></el-table-column>
      <el-table-column
        prop="username"
        label="关联用户数"
        min-width="240"
        ...
        sortable
      ></el-table-column>
      <el-table-column prop="create_time" label="添加时间" min-width="200" sortable></el-table-column>
...
export default {
  ...
  methods: {
    ...
    roleGroupList() {
      ...
      resName
        .GetRoleGroupList(para)
        .then(res => {
          //数据处理
          //console.log("用户角色组列表信息：" + JSON.stringify(res.data));
          if (res.status === 200) {
            if (res.data.code === 1) {
