      ...
      <el-tab-pane label="编辑文章">
        ...
        >
          <el-form-item label="文章标题" prop="title">
            <el-input placeholder="文章标题" v-model="editForm.title" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item label="文章排序" prop="listorder">
            <el-input placeholder="排序" v-model="editForm.listorder" auto-complete="off"></el-input>
          </el-form-item>
  ...
  methods: {
          ...
          resName
            ...
            .then(res => {
              ...
              if (res.data.code === 1) {
                ...
                this.$router.replace({ path: "/allArticle?id=" + this.editForm.cat_id});
              } else if (res.code === -2) {
                this.$message({
                  message: res.msg,
                  type: "error"
    ...
    uploadMainImg1() {
      ...
      resName
        ...
        .then(res => {
          if (res.data.code === 1) {
            if(_this.editForm.image !== ""){
              let imgUrl = _this.editForm.image;
